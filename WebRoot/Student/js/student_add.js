$(function () {
	...
	$("#student_classObj_classNumber").combobox({
        ...
        onLoadSuccess: function () { //数据加载完毕事件
            var data = $("#student_classObj_classNumber").combobox("getData"); 
            if (data.length > 0) {
                $("#student_classObj_classNumber").combobox("select", data[0].classNumber);
            }
        }
	});
