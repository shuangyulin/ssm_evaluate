    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>CourseScore/frontlist">课程成绩</a></li>
                <li><a href="<%=basePath %>AddScoreItem/frontlist">加分项目</a></li>
                <li><a href="<%=basePath %>StudentAddScore/frontlist">学生加分</a></li>
                <li><a href="<%=basePath %>FinalScore/frontlist">综合成绩</a></li>
                <li><a href="<%=basePath %>Teacher/frontlist">辅导员</a></li>
