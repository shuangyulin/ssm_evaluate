...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Teacher/frontlist">辅导员信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户名:</div>
		<div class="col-md-10 col-xs-6"><%=teacher.getTeacherUserName()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=teacher.getBirthday()%></div>
	</div>
	<div class="row bottom15"> 
