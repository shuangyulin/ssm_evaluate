...
<%
    ...
    String teacherUserName = (String)request.getAttribute("teacherUserName"); //用户名查询关键字
    String teacherName = (String)request.getAttribute("teacherName"); //姓名查询关键字
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#teacherListPanel" aria-controls="teacherListPanel" role="tab" data-toggle="tab">辅导员列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Teacher/teacher_frontAdd.jsp" style="display:none;">添加辅导员</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>用户名</td><td>姓名</td><td>性别</td><td>出生日期</td><td>联系电话</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<teacherList.size();i++) {
					    	            		...
					    	            		Teacher teacher = teacherList.get(i); //获取到辅导员对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											...
 											<td>
 												<a href="<%=basePath  %>Teacher/<%=teacher.getTeacherUserName() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="teacherEdit('<%=teacher.getTeacherUserName() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="teacherDelete('<%=teacher.getTeacherUserName() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="teacherQueryForm" id="teacherQueryForm" action="<%=basePath %>Teacher/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				...
				<input type="text" id="teacherUserName" name="teacherUserName" value="<%=teacherUserName %>" class="form-control" placeholder="请输入用户名">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="teacherName" name="teacherName" value="<%=teacherName %>" class="form-control" placeholder="请输入姓名">
			</div>
...
/*删除辅导员信息*/
function teacherDelete(teacherUserName) {
	if(confirm("确认删除这个记录")) {
		$.ajax({
			type : "POST",
			url : basePath + "Teacher/deletes",
			data : {
				teacherUserNames : teacherUserName,
			},
