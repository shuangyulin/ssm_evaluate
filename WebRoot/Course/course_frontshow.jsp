...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Course/frontlist">课程信息信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程类型:</div>
		<div class="col-md-10 col-xs-6"><%=course.getCourseType()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=course.getTeacherName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程总学时:</div>
		<div class="col-md-10 col-xs-6"><%=course.getCourseHour()%></div>
	</div>
	<div class="row bottom15">
