...
<%
    ...
    String courseType = (String)request.getAttribute("courseType"); //课程类型查询关键字
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Course/course_frontAdd.jsp" style="display:none;">添加课程信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>课程编号</td><td>课程名称</td><td>课程类型</td><td>课程学分</td><td>上课老师</td><td>课程总学时</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<courseList.size();i++) {
					    	            		...
					    	            		Course course = courseList.get(i); //获取到课程信息对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="courseQueryForm" id="courseQueryForm" action="<%=basePath %>Course/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="courseType" name="courseType" value="<%=courseType %>" class="form-control" placeholder="请输入课程类型">
			</div>
