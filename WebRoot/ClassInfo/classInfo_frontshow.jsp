...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=classInfo.getColleageObj().getColleageName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">班主任:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getBanzhuren()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">开办日期:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getStartDate()%></div>
	</div>
	<div class="row bottom15">
