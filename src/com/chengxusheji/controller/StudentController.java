...
public class StudentController extends BaseController {
	...
	public void list(String studentName,String birthday,String studentNumber,@ModelAttribute("classObj") ClassInfo classObj,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		if (page==null || page == 0) page = 1;
		if (studentName == null) studentName = "";
		if (birthday == null) birthday = "";
		if (studentNumber == null) studentNumber = "";
		if(rows != 0)studentService.setRows(rows);
		List<Student> studentList = studentService.queryStudent(studentName, birthday, studentNumber, classObj, page);
	    /*计算总的页数和总的记录数*/
	    studentService.queryTotalPageAndRecordNumber(studentName, birthday, studentNumber, classObj);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String studentName,String birthday,String studentNumber,@ModelAttribute("classObj") ClassInfo classObj,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (studentName == null) studentName = "";
		if (birthday == null) birthday = "";
		if (studentNumber == null) studentNumber = "";
		List<Student> studentList = studentService.queryStudent(studentName, birthday, studentNumber, classObj, currentPage);
	    /*计算总的页数和总的记录数*/
	    studentService.queryTotalPageAndRecordNumber(studentName, birthday, studentNumber, classObj);
	    /*获取到总的页码数目*/
	    int totalPage = studentService.getTotalPage();
	...
	public void OutToExcel(String studentName,String birthday,String studentNumber,@ModelAttribute("classObj") ClassInfo classObj, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(studentName == null) studentName = "";
        if(birthday == null) birthday = "";
        if(studentNumber == null) studentNumber = "";
        List<Student> studentList = studentService.queryStudent(studentName,birthday,studentNumber,classObj);
        ...
        for(int i=0;i<studentList.size();i++) {
        	...
        	dataset.add(new String[]{student.getStudentNumber(),student.getClassObj().getClassName(),student.getStudentName(),student.getSex(),student.getBirthday(),student.getStudentPhoto(),student.getTelephone(),student.getEmail()});
        }
        /*
