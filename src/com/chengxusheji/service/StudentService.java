...
public class StudentService {
    ...
    /*按照查询条件分页查询学生信息记录*/
    public ArrayList<Student> queryStudent(String studentName,String birthday,String studentNumber,ClassInfo classObj,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String studentName,String birthday,String studentNumber,ClassInfo classObj) throws Exception  { 
     	String where = "where 1=1";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
    	if(!birthday.equals("")) where = where + " and t_student.birthday like '%" + birthday + "%'";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String studentName,String birthday,String studentNumber,ClassInfo classObj) throws Exception {
     	String where = "where 1=1";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
    	if(!birthday.equals("")) where = where + " and t_student.birthday like '%" + birthday + "%'";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
